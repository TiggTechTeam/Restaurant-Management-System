...
public class Restaurant {
	...
	private void initialize() {
		...
		jCmbDrink.setModel(new DefaultComboBoxModel(new String[] {"Coke", "Fanta", "Water ", "Spezi"}));
		...
		jcmbCurrency.setModel(new DefaultComboBoxModel(new String[] {"Germany", "USA", "France", "Spain", "UK", "Australia"}));
